...
// Adding a fifth score to the array
scores.push(5);

console.log("An extra score added: " + scores[4]);

// Displaying the last score using scores.length
console.log("The last score is " + scores[scores.length - 1]);

// Adding another score to the array
scores.push(9);

console.log("An extra score added: " + scores[5]);
