...
// Function to show a specific item of the player
var showItem = function (player, itemNumber) {
  var itemIndex = itemNumber - 1; // Adjusting to zero-based index
...
// Testing showItem function
showItem(player1, 1); // Displaying the first item



// Function to add an item to the player's items
...
addItem(player1, "a mysterious key");
